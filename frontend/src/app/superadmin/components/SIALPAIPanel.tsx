...
export function SIALPAIPanel() {
  ...
  function exportarExcel() {
    const rows = [
      ...
      [`RESPONSABLE: ${responsable}`, `N° MATRICULA: ${nMatricula}`],
      [],
      ['N° HC','N° ASEGURADO','APELLIDO Y NOMBRES','TIPO PAC','EDAD M','EDAD F','PESO','TALLA','BCG','HB','PENTAVALENTE','IPV','OPV','ROTAVIRUS','NEUMOCOCO','SPR','DPT','INFLUENZA','FA','HEPATITIS A','TOXOIDE','COVID-19','DOSIS 1','DOSIS 2','DOSIS 3','DOSIS R','ALERTA EPID.','TIPO ALERTA','ESAVI','DESC. ESAVI','OBSERVACION'],
      ...filas.map((f,i) => [
          ...
          <table className="text-xs border-collapse" style={{ minWidth: '2000px' }}>
            <thead className="sticky top-0 z-10">
              <tr className="bg-green-800 text-white">
                ...
                <th className="border border-green-700 px-1 py-1.5 text-center w-16" rowSpan={2}>N° HC</th>
                <th className="border border-green-700 px-1 py-1.5 text-center w-20" rowSpan={2}>N° Asegurado</th>
