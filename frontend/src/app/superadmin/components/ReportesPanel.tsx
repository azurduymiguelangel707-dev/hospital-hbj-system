              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white border border-gray-200 rounded-xl p-4">
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    {data.fechaInicio ? new Date(data.fechaInicio).toLocaleDateString("es-ES",{day:"2-digit",month:"short",year:"numeric"}) : ""} al {data.fechaFin ? new Date(data.fechaFin).toLocaleDateString("es-ES",{day:"2-digit",month:"short",year:"numeric"}) : ""}
                  </p>
                </div>
                <div className="bg-white border border-gray-200 rounded-xl p-4">
                  ...
                  {(data.stats?.total ?? 0) > 0 ? (
                    <div className="flex items-center gap-4">
                      <ResponsiveContainer width="55%" height={160}>
                        <PieChart>
                          <Pie data={[{ name: "Masculinos", value: data.stats?.masculinos ?? 0 },{ name: "Femeninas", value: data.stats?.femeninos ?? 0 }]}
                          ...
                          <div key={i}>
                            <div className="flex items-center justify-between mb-1">
                              <span className="text-xs text-gray-600 flex items-center gap-1.5">
                                <span className="w-2.5 h-2.5 rounded-full inline-block" style={{ backgroundColor: g.color }}/>{g.label}
                              </span>
