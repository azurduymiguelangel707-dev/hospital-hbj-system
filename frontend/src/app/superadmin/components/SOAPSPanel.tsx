...
export function SOAPSPanel() {
  ...
  function exportarExcel() {
    const rows = [
      ...
      [`MEDICO: ${medico}`, `Num. MATRICULA: ${nMatricula}`],
      [],
      ['Num. HC','Num. ASEGURADO','APELLIDO Y NOMBRES','TIPO PAC','EDAD M','EDAD F','PESO','TALLA','ESPECIALIDAD','CONS. NUEVA','CONS. REP.','EMERGENCIA','HOSPITALIZACION','NIVEL ATENCION','SUBJETIVO','OBJETIVO','ANALISIS','PLAN','REFERENCIA','NIVEL REF.','ESTABLECIMIENTO REF.','CONTRARREF.','CIE 10','DIAGNOSTICO','ALTA','SEGUIMIENTO','INTERNACION'],
      ...filas.map((f,i) => [
          ...
          <table className="text-xs border-collapse" style={{ minWidth: '2200px' }}>
            <thead className="sticky top-0 z-10">
              <tr className="bg-purple-800 text-white">
                ...
                <th className="border border-purple-700 px-1 py-1.5 text-center w-16" rowSpan={2}>Num. HC</th>
                <th className="border border-purple-700 px-1 py-1.5 text-center w-20" rowSpan={2}>Num. Asegurado</th>
