        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
            <div className="flex flex-col items-center mb-6">
              ...
              <span className="text-xs text-gray-400 mt-1">NÃ‚Â° Historial: {paciente.numeroHistorial}</span>
            </div>
                          ...
                          return (
                            <div key={c.id} className="flex items-center gap-4 p-3 rounded-xl border border-gray-50 hover:bg-gray-50">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-xs text-gray-400">{formatFecha(c.appointmentDate)} Ã‚Â· {c.appointmentTime?.substring(0,5) ?? ''} Ã‚Â· Ficha {c.numeroFicha}/{c.totalFichasTurno}</p>
                              </div>
                        ...
                        documentos.map((d: any) => (
                          <div key={d.id} className="flex items-center gap-3 p-3 rounded-xl border border-gray-50 hover:bg-gray-50">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-xs text-gray-400">{d.tipo} Ã‚Â· {formatFecha(d.creadoEn)}</p>
                            </div>
  ...
  return (
    <div>
      ...
      <div className="relative mb-5">
        ...
        <input type="text" placeholder="Buscar por nombre, CI o NÃ‚Â° historial..."
