...
export default function PatientDashboard() {
  ...
  const fetchData = async () => {
    try {
      ...
      // En producciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n, esto filtrarÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­a por el ID del paciente autenticado
  ...
  const handleBookAppointment = async () => {
    try {
      // En producciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n, obtendrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­a el patientId del usuario autenticado
      ...
      if (response.ok) {
        await fetchData();
        closeModal();
        alert('ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡Cita agendada exitosamente!');
      }
    } catch (error) {
  ...
  const handleCancelAppointment = async (id: string) => {
    if (!confirm('ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿EstÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡s seguro de cancelar esta cita?')) return;
  ...
  // Separar citas prÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³ximas y pasadas
  ...
  const pastAppointments = appointments
    ...
    .slice(0, 10); // Solo las ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºltimas 10
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">Gestiona tus citas mÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©dicas</p>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg shadow-lg p-6 mb-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold mb-2">ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿Necesitas una consulta mÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©dica?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 mb-1">PrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³ximas Citas</p>
        ...
        {/* PrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³ximas Citas */}
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Mis PrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³ximas Citas</h2>
                          ...
                          <div className="flex items-center text-gray-700 mb-1">
                            ...
                            <span className="font-semibold">
                              {app.doctor?.user 
                                ...
                                : 'MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©dico no asignado'}
                            </span>
                          </div>
              ...
              <table className="w-full">
                <thead className="bg-gray-50 border-b">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©dico</th>
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Selecciona un MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©dico</label>
                  <select
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                    rows={3}
                    placeholder="InformaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n adicional que el mÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©dico deba saber..."
                  />
                </div>
              </div>
