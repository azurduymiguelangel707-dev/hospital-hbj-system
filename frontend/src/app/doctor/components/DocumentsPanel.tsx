                  ...
                  return (
                    <div key={doc.id} className="flex items-center gap-3 border border-gray-200 rounded-lg px-3 py-2.5 hover:bg-gray-50 transition">
                      ...
                      <div className="flex gap-1 flex-shrink-0">
                        <a href={doc.fileUrl?.startsWith('http') ? doc.fileUrl : (process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3001').replace('/api','') + doc.fileUrl} target="_blank" rel="noopener noreferrer"
